...
abstract class REST_Controller extends CI_Controller
{
    ...
    */
    ...
    public function response($data = null, $http_code = null, $continue = false)
    {
       ...
       /*
        * nhutnguyen - fix 'Last few characters missing in Codeigniter REST API, json Response'
        * http://stackoverflow.com/questions/19218450/last-few-characters-missing-in-codeigniter-rest-api-json-response
        *
